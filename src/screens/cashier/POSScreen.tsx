...
const styles = StyleSheet.create({
  ...
  searchDropdown: { position: 'absolute', top: 64, left: 0, right: 0, zIndex: 100, backgroundColor: COLORS.surface, borderBottomWidth: 1, borderBottomColor: COLORS.border, maxHeight: 300, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 10 },
  ...
  qtyBtn: { width: 32, height: 32, borderRadius: 16, backgroundColor: COLORS.background, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: COLORS.border },
  ...
  emptyCartSub: { fontSize: 14, color: COLORS.textLight, marginTop: 4 },
  ...
  presetModal: { backgroundColor: COLORS.surface, borderRadius: 16, padding: 24, width: 280 },
  ...
  discountModalContent: { backgroundColor: COLORS.surface, borderRadius: 16, padding: 24, width: 300 },
